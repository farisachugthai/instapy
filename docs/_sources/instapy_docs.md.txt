...
1. **Uninstall Google Chrome**
	I used an app called <https://freemacsoft.net/appcleaner> to remove Chrome.
...
2. **Download Chrome 65** *(Read this step completely before proceeding)*
  ...
  - Wait why is this not a link to Google's website?

	- Find and install Chrome 65 from <https://www.slimjet.com/chrome/google-chrome-old-version.php>
